...
<footer class="main-footer d-none d-md-block">
    ...
    Build With : <a href="#" data-toggle="tooltip" title="Lihat Situs" target="_blank">Estetika Karya</a>
    </div>
    <strong>Copyright &copy; {{ date('Y') }} <a href="#" data-toggle="tooltip" title="Lihat Situs" target="_blank">Estetika Karya</a>.</strong> All rights reserved.
</footer>