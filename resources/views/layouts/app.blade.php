...
<head>
    ...
    <title>{{ config('app.name', 'CV.ESTETIKA KARYA') }} - CV ESTETIKA KARYA</title>
...
<body data-scrollbar-auto-hide="n" class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm sidebar-closed">
