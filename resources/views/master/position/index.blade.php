        ...
        <div class="container-fluid">
            <form>
                <div class="form-inline">
                    ...
                    <a href="{{ route('master.position.create') }}" role="button" class="btn btn-primary btn-xl app-shadow d-none d-md-inline-block ml-auto" style="border-radius:50%"><i class="fa fa-plus"></i>
                    </a>
                </div>
            </form>
        </div>
