...
@section('content')
            ...
            <div class="container-fluid">
                <form>
                    <div class="form-inline">
                        ...
                        <a href="{{ route('overtime.create') }}" class="btn btn-default app-shadow d-none d-md-inline-block ml-auto">
    ...
    <a href="{{ route('overtime.create') }}" class="btn btn-lg rounded-circle btn-primary btn-fly d-block d-md-none app-shadow">
