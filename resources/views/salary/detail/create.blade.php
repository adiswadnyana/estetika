...
<script>
    ...
    $('input[name=lembur]').change(function() {
        ...
        if (this.checked == true) {
            ...
            let total = parseInt(salary) + parseInt(transportasi) - parseInt(pot_bpjs);
    ...
    $(document).on('keyup', '#gaji_lembur', function() {
        ...
        let pot_bpjs = $('#pot_bpjs').val() || 0;
        let transportasi = $('#transportasi').val() || 0;
        let total = parseInt(salary) + parseInt(transportasi) + parseInt(total_lembur) - parseInt(pot_bpjs);
        $('#grand_total_salary').html(to_rupiah(total));
        $('#grand_total_salary_hidden').val(total);
    });
    ...
    function HitungTotal() {
        ...
        let pot_bpjs = $('#pot_bpjs').val() || 0;
        let transportasi = $('#transportasi').val() || 0;
        let total = parseInt(transportasi) + parseInt(salary) - parseInt(pot_bpjs);
        $('#grand_total_salary').html(to_rupiah(total));
        $('#grand_total_salary_hidden').val(total);
    }
